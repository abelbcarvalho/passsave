...
class LoginUpdate:
    """Classe de tela para atualização de Login.
    ...
    def __init__(self, login=Login()):
        ...
        self._login = login
        self.window = Tk()
        self.window.minsize(512, 450)
        self.window.maxsize(512, 450)
        self.window.title('PassSave - Atualizar Login')
        ...
        self.title_label['text'] = 'Atualize Login Existente'
        self.title_label.pack(pady=15)

        self.id_label = Label(self.title_frame)
        self.id_label['font'] = self._font_pequena
        self.id_label['text'] = 'ID Chave:'
        self.id_label.pack(side=LEFT)

        self.id_acc_label = Label(self.title_frame)
        self.id_acc_label['font'] = self._font_pequena
        self.id_acc_label['text'] = f'{self._login.id}'
        self.id_acc_label['bg'] = '#ffff00'
        self.id_acc_label.pack(side=LEFT)
        ...
        self.create_button['text'] = 'Atualizar'
